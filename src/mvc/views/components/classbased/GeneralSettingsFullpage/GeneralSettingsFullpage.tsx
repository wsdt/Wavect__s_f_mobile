...
import {notImplementedYet} from '../../functional/Utils/Utils'
            ...
            <View style={styles.mainView}>
                ...
                <View style={styles.navigationView}>
                    <AppText
                        ...
                        onPress={() => this.props.navigation.navigate(routes.PersonalSettingsFullpage)}> Persönliche Daten hinterlegen </AppText>
                    <AppText
                        style={styles.navText}
                        onPress={() => notImplementedYet()}> Idee für Challenge einreichen </AppText>
                    <AppText
                        style={styles.navText}
                        onPress={() => Linking.openURL('https://wordpress.dev.wavect.io/')}> Homepage besuchen </AppText>
                    <AppText
                        style={styles.navText}
                        onPress={() => Linking.openURL('https://wordpress.dev.wavect.io/privacy-policy/')}> Teilnahmebedingungen </AppText>
                    <AppText
                        style={styles.navText}
                        onPress={() => Linking.openURL('https://wordpress.dev.wavect.io/privacy-policy/')}> AGB </AppText>
                </View>
            </View>
        )
    }
