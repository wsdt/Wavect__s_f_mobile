        ...
        <View>
            ...
            <ScrollView>
                <View>
                    ...
                    <Text style={styles.blockText}> Die Idee für taurinhaltige Getränke kam aus Japan, wo sie im Zweiten Weltkrieg japanischen Piloten zur Steigerung der Leistung verabreicht wurden. Aus Thailand importierte der Gründer der Red Bull GmbH, Dietrich Mateschitz, später die Idee nach Europa. Bei einem Besuch 1982 in Thailand stellte er fest, dass ihm ein Getränk namens Krating Daeng half, den Einfluss des Jetlags zu überwinden.[2] Zusammen mit dem Thailänder Yoovidhya Chalerm gründete Mateschitz in Österreich die Red Bull GmbH, sie übernahmen Marketingkonzept und Grundrezeptur, passten diese dem westlichen Geschmack an und gingen damit 1987 auf den europäischen Markt. Ende der 1980er Jahre wurde Red Bull vor allem durch geschicktes Marketing in der alternativen Jugend- und Club-Szene (Techno, Mountainbiking, Snowboarding) erfolgreich.
                        ...
                        Red Bull hat keine eigenen Produktionsstätten, sondern lässt das Getränk bei der Firma Rauch Fruchtsäfte in Nüziders[5] (Vorarlberg) produzieren und abfüllen. Für den Export wird Red Bull nicht als Konzentrat produziert, sondern fertig in Dosen abgefüllt nach Übersee exportiert. Für den amerikanischen Markt wird es von Rauch in der Schweiz abgefüllt, wo ein Werk in Widnau SG errichtet wurde. Dieser Standort wurde gewählt, um bei Handelsstreitigkeiten zwischen der EU und den USA nicht betroffen zu sein.[6] </Text>
