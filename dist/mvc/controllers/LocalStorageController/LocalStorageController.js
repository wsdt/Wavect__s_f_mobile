...
exports.getLocalItem = function (key) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4, async_storage_1.default.getItem(key)];
            case 2:
                queriedValue = _a.sent();
                return [3, 4];
            case 3:
                e_1 = _a.sent();
                LoggingController_1.logEvent(LoggingController_1.LogType.ERROR, TAG + ":getLocalItem", "Could not query item with key '" + key + "' from local storage.");
                return [3, 4];
            case 4: return [2, queriedValue];
        }
    });
}); };
exports.setLocalItem = function (key, val) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4, async_storage_1.default.setItem(key, val)];
            case 1:
                _a.sent();
                return [3, 3];
            case 2:
                e_2 = _a.sent();
                LoggingController_1.logEvent(LoggingController_1.LogType.ERROR, TAG + ":setLocalItem", "Could not save item with key '" + key + "' and value '" + val + "'.");
                return [3, 3];
            case 3: return [2];
        }
    });
...
var generateNewUserId = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                e_3 = _a.sent();
                LoggingController_1.logEvent(LoggingController_1.LogType.ERROR, TAG + ":markEmailAsCreated", e_3);
                return [3, 4];
            case 4: return [2, newUserId];
        }
    });
}); };
...
exports.markEmailAsCreated = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                e_4 = _a.sent();
                LoggingController_1.logEvent(LoggingController_1.LogType.ERROR, TAG + ":markEmailAsCreated", e_4);
                return [2, false];
            case 3: return [2];
        }
    });
