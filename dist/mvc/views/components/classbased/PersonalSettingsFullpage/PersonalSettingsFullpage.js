...
var PersonalSettingsFullpage = (function (_super) {
    ...
    function PersonalSettingsFullpage() {
        ...
        _this.emailValidation = function (email) {
            _this.setState({ email: email, validEmail: PersonalSettingsFullpage.EMAIL_REGEX.test(email) });
        };
    ...
    PersonalSettingsFullpage.prototype.componentDidMount = function () {
        var _this = this;
        this.getUserSettings(false);
        this.loadingContext.setRefresh(function (cb) { return _this.getUserSettings(true, cb); });
    };
    PersonalSettingsFullpage.prototype.render = function () {
        var _this = this;
    ...
    PersonalSettingsFullpage.prototype.componentWillUnmount = function () {
        this.abortController.abort();
    };
    PersonalSettingsFullpage.API_ENDPOINT = globalConfig_1.BACKEND_MOBILE_API + "/settings";
    PersonalSettingsFullpage.EMAIL_REGEX = /^\w+([.-]?\w+)*@\w+([.-]?\w+)*(\.\w{2,3})+$/;
    return PersonalSettingsFullpage;
}(react_1.default.PureComponent));
exports.PersonalSettingsFullpage = PersonalSettingsFullpage;
exports.default = react_navigation_props_mapper_1.withMappedNavigationParams()(PersonalSettingsFullpage);
